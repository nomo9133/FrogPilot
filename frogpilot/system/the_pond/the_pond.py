...
from openpilot.frogpilot.common.frogpilot_variables import ERROR_LOGS_PATH, EXCLUDED_KEYS, SCREEN_RECORDINGS_PATH, THEME_SAVE_PATH, frogpilot_default_params, params, update_frogpilot_toggles
...
def setup(app):
  ...
  def delete_theme(theme_name):
    ...
    user_created_file = theme_path / "user_created"
    with open(user_created_file, 'w') as f:
      pass

    return jsonify({"message": f"Theme '{theme_name}' marked for deletion."}), 200
